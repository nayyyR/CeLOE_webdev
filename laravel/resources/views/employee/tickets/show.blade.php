<x-layouts.app :title="$ticket->ticket_number . ' - Celoe'">
    <div class="mb-8 flex items-center justify-between">
        ...
        <a href="{{ route('employee.tickets.assigned') }}" class="inline-flex items-center rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 transition-colors">Back to List</a>
    </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            @if ($ticket->status !== 'closed')
                <div class="rounded-xl bg-white shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <form method="POST" action="{{ route('employee.tickets.reply', $ticket) }}" enctype="multipart/form-data" class="p-6">
                        @csrf
                        <div>
        ...
        <div class="space-y-6">
            ...
            <div class="rounded-xl bg-white shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    {{-- Employee can only resolve in_progress tickets --}}
                    @if ($ticket->status === 'in_progress')
                        <form method="POST" action="{{ route('employee.tickets.status', $ticket) }}">
                            @csrf
                            @method('PUT')
